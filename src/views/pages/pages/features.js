...
class Pages extends React.Component {
    ...
    render() {
        return <SwitchTransition><CSSTransition key={`help`}
          ...
          <p>GrimWire is a wiki-like application that makes it easy to see the vast relationships between ideas, 
            cultures, and magickal objects. And soon, you can add your own private notes to each article and object,
            keeping everything in the same place.</p>
          ...
          <p>Add your own private notes to publically created pages. Edit and sort them in folders.</p>
