...
class Pages extends React.Component {
    ...
    render() {
        ...
        <h3>1a. What is this terminology?</h3>
        ...
        <h3>c. Teachings Sources People Stories</h3>

        <h3>d. Source Connections vs Sources vs Resources</h3>

        <h3>e. Rituals vs. Spells</h3>
        ...
        <h3>4. Why are you spelling magick like that that?</h3>
